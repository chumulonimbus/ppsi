...
<body>    
    <form class="form-signin" action="register/submit" method="post" enctype="multipart/form-data">
        <div class="text-center mb-4">
            ...
            <h1 class="h3 mb-3 font-weight-normal">Create My Account</h1>
        ...
        <div class="form-label-group">
            <input type="file" id="inputfile" name="file" class="form-control" placeholder="Browse" style="height: 4.125rem;padding-top: 1.75rem;">
            <label for="inputfile">File</label>
        </div>

        <button class="btn btn-lg btn-primary btn-block mb-2" type="submit">Sign Up</button>
        <div class="d-flex">
            <!-- <a href="<?php echo base_url('resPassword') ?>" class="mr-auto">Forgot password</a> -->
